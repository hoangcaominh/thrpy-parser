...
const PARSERS = {}
PARSERS[C.GAME.TH06.MAGIC] = require("./parse06")
PARSERS[C.GAME.TH07.MAGIC] = require("./parse07")
PARSERS[C.GAME.TH08.MAGIC] = require("./parse08")
PARSERS[C.GAME.TH09.MAGIC] = require("./parse09")
PARSERS[C.GAME.TH10.MAGIC] = require("./parse10")
PARSERS[C.GAME.TH11.MAGIC] = require("./parse11")
PARSERS[C.GAME.TH12.MAGIC] = require("./parse12")
PARSERS[C.GAME.TH128.MAGIC] = require("./parse128")
/**
 ...
 * - raviddog
 */
PARSERS[C.GAME.TH13.MAGIC] = require("./parse13or14")
PARSERS[C.GAME.TH15.MAGIC] = require("./parse15")
PARSERS[C.GAME.TH16.MAGIC] = require("./parse16")
PARSERS[C.GAME.TH17.MAGIC] = require("./parse17")
PARSERS[C.GAME.TH18.MAGIC] = require("./parse18")
