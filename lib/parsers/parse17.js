...
/**
 * Parses th17 replay and returns the replay's information
 * @param {Buffer} replay 
 * @returns Information about the replay
 */
function parse17(replay) {
    ...
    // Replay
    const R = new Th17(new KaitaiStream(unlzss(compData)))
    ...
    // TODO: Add missing fields (e.g tokens and hyper)
    const stages = []
