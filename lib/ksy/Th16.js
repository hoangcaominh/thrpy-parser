...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Th16 = factory(root.KaitaiStream);
  }
}(typeof self !== 'undefined' ? self : this, function (KaitaiStream) {
var Th16 = (function() {
  function Th16(_io, _parent, _root) {
    this._io = _io;
  ...
  var Header = Th16.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      this.season = this._io.readU4le();
    }

    return Header;
  })();

  var Stage = Th16.Stage = (function() {
    ...
    Stage.prototype._read = function() {
      ...
      this.timeInStage = this._io.readU4le();
      this.timeInChapterPossiblyBroken = this._io.readU4le();
      this.shot = this._io.readU4le();
      this.subshotUnused = this._io.readU4le();
      this.season = this._io.readU4le();
      this.score = this._io.readU4le();
      ...
      this.grazeChapterPossiblyBroken = this._io.readU4le();
      this.spellPracticeId = this._io.readU4le();
      ...
      this.nextScoreExtendId = this._io.readU4le();
      this.bombs = this._io.readU4le();
      this.bombPieces = this._io.readU4le();
      this.seasonPower = this._io.readU4le();
      this.seasonPowerMax = this._io.readU4le();
      this.unknown4 = [];
      for (var i = 0; i < 10; i++) {
        this.unknown4.push(this._io.readU4le());
      }
      this.seasonPowerRequired = [];
      for (var i = 0; i < 6; i++) {
        this.seasonPowerRequired.push(this._io.readU4le());
      }
      this.seasonPowerMax2 = this._io.readU4le();
      this.unknown5 = [];
      for (var i = 0; i < 7; i++) {
      ...
      this.th14ItemSpawnCount = this._io.readU4le();
      this.unknown6 = this._io.readBytes(308);
