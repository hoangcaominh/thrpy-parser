...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Th15 = factory(root.KaitaiStream);
  }
}(typeof self !== 'undefined' ? self : this, function (KaitaiStream) {
var Th15 = (function() {
  function Th15(_io, _parent, _root) {
    this._io = _io;
  ...
  var Header = Th15.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      this.unknown1 = this._io.readBytes(108);
  ...
  var Stage = Th15.Stage = (function() {
    ...
    Stage.prototype._read = function() {
      ...
      this.timeInChapter = this._io.readU4le();
      this.shot = this._io.readU4le();
      this.subshotUnused = this._io.readU4le();
      this.score = this._io.readU4le();
      this.difficulty = this._io.readU4le();
      ...
      this.grazeChapter = this._io.readU4le();
      this.spellPracticeId = this._io.readU4le();
      this.unknown2 = this._io.readU4le();
      ...
      this.extends = this._io.readU4le();
      ...
      this.enemiesInChapter = this._io.readU4le();
      this.enemiesKilledInChapter = this._io.readU4le();
      this.bgmFn = this._io.readBytes(256);
      this.unknown8 = this._io.readU4le();
      this.unknown9 = this._io.readU4le();
      this.pdResetsTotal = this._io.readU4le();
      this.pdResetsStage = [];
      for (var i = 0; i < 8; i++) {
        this.pdResetsStage.push(this._io.readU4le());
      }
      this.pdResetsChapter = this._io.readU4le();
