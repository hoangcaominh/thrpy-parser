...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Th13 = factory(root.KaitaiStream);
  }
}(typeof self !== 'undefined' ? self : this, function (KaitaiStream) {
var Th13 = (function() {
  function Th13(_io, _parent, _root) {
    this._io = _io;
  ...
  var Header = Th13.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      this.unknown = this._io.readBytes(60);
  ...
  var Stage = Th13.Stage = (function() {
    ...
    Stage.prototype._read = function() {
      ...
      this.powerMin = this._io.readU4le();
